...
resource "aws_subnet" "public" {
  ...
  # Security: Do NOT auto-assign public IPs to reduce attack surface
...
resource "aws_security_group" "bastion" {
  ...
  description = "Security group for bastion host - SSH restricted to specific CIDR"
  vpc_id      = aws_vpc.main.id

  # SECURITY GUARDRAIL: SSH restricted, never from 0.0.0.0/0
  ingress {
    ...
    Statement = [
      {
        ...
        Effect = "Allow"
        # SECURITY: Specific resource ARN instead of wildcard
